...
function simplepie_init() {
	...
	elgg_register_library('simplepie', $path . 'vendors/simplepie.inc');
	...
	// override the default url to view a simplepie object
	elgg_register_entity_url_handler('object', 'simplepie', 'simplepie_url_handler');
 ...
 */
function simplepie_url_handler($entity) {
